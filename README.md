...
Predicting Spotify track popularity (0–100) from audio features using LightGBM, Random Forest, Linear Regression, and a shallow Neural Network. Includes SHAP explainability analysis and genre mean-target encoding.
